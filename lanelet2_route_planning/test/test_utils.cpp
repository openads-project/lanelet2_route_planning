...
lanelet::Lanelet makeLanelet(lanelet::Id id, double y) {
  ...
  lanelet::LineString3d right_bound(id + 4,
                                    {lanelet::Point3d(id + 5, 0.0, y - 1.0, 0.0), lanelet::Point3d(id + 6, 10.0, y - 1.0, 0.0)});
...
TEST(ExtractRegulatoryElements, SkipsLaneletWithRightOfWay) {  // NOLINT
  ...
  auto right_of_way = lanelet::RightOfWay::make(400, lanelet::AttributeMap(), {right_of_way_lanelet}, {yield_lanelet}, stop_line);
...
TEST(ExtractRegulatoryElements, AssignsSharedRightOfWayOnlyToYieldLanelet) {  // NOLINT
  auto right_of_way_lanelet = makeLanelet(100, 0.0);
  ...
  const auto result = extractRegulatoryElements(right_of_way_lanelet, {}, {yield_lanelet}, makePointSequence(0.0));
...
TEST(ExtractRegulatoryElements, RejectsIntersectionOutsideReferenceLineSegment) {  // NOLINT
  ...
  auto right_of_way =
      lanelet::RightOfWay::make(400, lanelet::AttributeMap(), {right_of_way_lanelet}, {yield_lanelet}, distant_stop_line);
  yield_lanelet.addRegulatoryElement(right_of_way);
...
TEST(ExtractRegulatoryElements, RejectsParallelReferenceLine) {  // NOLINT
  ...
  auto right_of_way =
      lanelet::RightOfWay::make(400, lanelet::AttributeMap(), {right_of_way_lanelet}, {yield_lanelet}, parallel_stop_line);
  yield_lanelet.addRegulatoryElement(right_of_way);
